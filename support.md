...
2. Sign in to iCloud for automatic sync across devices
3. Enable notifications in Settings → Notifications (optional)
4. Add your first Else!

### Creating Your First Else
- Tap the **+** button in the Dashboard
...
**Q: I deleted the app and lost my data**
